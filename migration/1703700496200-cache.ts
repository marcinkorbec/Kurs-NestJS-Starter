...
export class cache1703700496200 implements MigrationInterface {
    name = 'cache1703700496200'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query("CREATE TABLE `cache` (`id` int NOT NULL AUTO_INCREMENT, `key` varchar(255) NOT NULL, `value` json NOT NULL, `controllerName` varchar(255) NOT NULL, `actionName` varchar(255) NOT NULL, `createdAt` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, PRIMARY KEY (`id`)) ENGINE=InnoDB");
        ...
        await queryRunner.query("ALTER TABLE `basket_item` CHANGE `userId` `userId` varchar(36) NULL");
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("ALTER TABLE `shop_item` DROP FOREIGN KEY `FK_474e4d5aa2855ea63c783ae1d44`");
        await queryRunner.query("ALTER TABLE `shop_item` DROP FOREIGN KEY `FK_97a163845911eca4232df8d62c3`");
        await queryRunner.query("ALTER TABLE `basket_item` CHANGE `userId` `userId` varchar(36) NULL DEFAULT 'NULL'");
